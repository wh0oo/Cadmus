...
public abstract class FireBlockMixin {
    ...
    private boolean cadmus$checkBurnOut(FireBlock ignored1, Level level, BlockPos toPos, int ignored2, RandomSource ignored3, int ignored4, BlockState fromState, ServerLevel ignored5, BlockPos fromPos, RandomSource ignored6) {
